"""
Security and Input Sanitization Module for Character Screening API
Provides comprehensive input validation, sanitization, and security logging
Enhanced for character screening operations including name validation and context sanitization
"""
